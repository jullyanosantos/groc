...
namespace Microservices.Application.Helpers
{
    public static class LinqExtensions
    {
        ...
        public static IQueryable<T> SortBy<T>(this IQueryable<T> source, string sortBy)
        {
            if (source == null)
        ...
        private static IQueryable<TSource> OrderBy<TSource>(this IQueryable<TSource> queryable, string sorts)
        {
        ...
        public class SortCollection<TSource>
        {
            ...
            private static ISortProperty<TSource>? Parse(string element)
            {
                ...
                var propertyInfo = properties.Find(p => p.Name.Equals(sortProperty, StringComparison.OrdinalIgnoreCase));
